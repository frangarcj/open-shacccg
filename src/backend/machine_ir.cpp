    ...
    for (uint32_t instruction_index = 0; instruction_index < program.instructions().size(); ++instruction_index) {
        ...
        case MachineOpcode::Vector: {
            ...
            if (swizzle != MachineVectorSwizzle::Identity &&
                swizzle != MachineVectorSwizzle::Source1OneOneXX &&
            ...
            if (swizzle == MachineVectorSwizzle::Source1OneOneXX) {
                op.src1_swizzle = {{usse::SwizzleChannel::One, usse::SwizzleChannel::One,
        ...
        case MachineOpcode::ComplexF32: {
            ...
            if (guard!=usse::Predicate::Always ||
                ...
                (config&~0x0003u)) {
                out.error="machine complex F32 operation is outside reciprocal/rsqrt/log2/exp2 subset";
                return false;
            }
